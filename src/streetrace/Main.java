...
public class Main {
    public static void main(String[] args) {
        ...
        Car car1 = new Car("Лада", "Веста", 1.6, new DriverB("B1st", true, 3));
        Car car2 = new Car("Audi", "A3", 2.0, driverB2);
        Car car3 = new Car("Subaru", "Impreza XV", 2.0, driverB3);
        Car car4 = new Car("Dodge", "Caliber SE", 2.5, driverB4);

        Truck truck1 = new Truck("Volvo", "Freightliner", 2.5, driverC1);
        Truck truck2 = new Truck("Mercedes Benz", "Cosmo", 3.0, driverC2);
        Truck truck3 = new Truck("Renault", "Skyliner", 2.7, driverC3);
        Truck truck4 = new Truck("MAN", "Model 5", 3.2, driverC4);

        Bus bus1 = new Bus("Mercedes Benz", "Allegro", 3.5, driverD1);
        Bus bus2 = new Bus("Ikarus", "Ikar", 2.5, driverD2);
        Bus bus3 = new Bus("Львив", "Львив 3", 2.2, driverD3);
        Bus bus4 = new Bus("Ssang Yuong", "Flying pigeon", 3.0, driverD4);
